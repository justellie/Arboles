...
{
    int diam_iz = -1, diam_der = -1, alt_izq = -1, alt_der = -1;
    /* Casos base, la altura del arbol nulo es -1 y la de una hoja 0 , 
        asi como su diametro.
    */
    if(ptr == NULL)
    {
        may = -1;
    ...
    {
        /* Existen dos posibilidades: el camino del diametro pasa por la raiz o
           no. En caso de que no pase por la raiz el diametro es el diametro de una de los
           subarboles. En el caso de que pase por la raiz el diametro son las alturas de los
           subarboles  + 2 debido a los dos arcos entre la raiz y los subarboles 
        */
        diametroNodo(ptr->obtHi(),diam_iz,alt_izq);
        diametroNodo(ptr->obtHd(),diam_der,alt_der);
